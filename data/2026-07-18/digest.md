...
### 15. [主观风险分解：不确定性量化的新观点](https://arxiv.org/abs/2607.15196v1)
...
### 1. [能量分配解释了原生动物表型特征如何响应温度和资源供应而变化](https://www.biorxiv.org/content/10.1101/2023.07.25.550219v9)
- Original title: Energy allocation explains how protozoan phenotypic traits change in response to temperature and resource supply
- Authors: Perna, A., Rivoli, E. S., Reiss, J., Perkins, D. M.
- Meta: 2026-07-18 | ecology | DOI: 10.1101/2023.07.25.550219
- 中文摘要: 为了生存和繁殖，生物体需要在能量摄入和能量消耗之间保持有效的平衡。环境条件的变化可能会破坏以前有效的能量分配策略，生物体需要改变其行为、生理或形态以应对新环境。然而，多种表型性状如何相互作用以及如何与环境条件相互作用以形成能量分配仍然知之甚少。
...
- Summary (fallback): 机器翻译摘要显示：为了生存和繁殖，生物体需要在能量摄入和能量消耗之间保持有效的平衡。环境条件的变化可能会破坏以前有效的能量分配策略，生物体需要改变其行为、生理或形态以应对新环境。然而，多种表型性状如何相互作用以及如何与环境条件相互作用以形成能量分配仍然知之甚少。
- Keywords: energy, changes, movement, allocation, phenotypic

## medrxiv

### 1. [绝经后女性的心肺健康、多基因风险和乳腺癌：一项前瞻性队列研究](https://www.medrxiv.org/content/10.64898/2026.03.12.26347589v4)
- Original title: Cardiorespiratory fitness, polygenic risk, and breast cancer in postmenopausal women: a prospective cohort study
- Authors: Tanisawa, K., Watanabe, D., Li, Q., Fan, X., Sun, X.
- Meta: 2026-07-18 | sports medicine | DOI: 10.64898/2026.03.12.26347589
- 中文摘要: 背景虽然较高的心肺健康（CRF）与较低的乳腺癌风险相关，但 CRF 是否改变多基因风险与乳腺癌之间的关联仍不清楚。我们研究了心肺健康（CRF）和多基因风险与乳腺癌发生的联合关联，以及较高的 CRF 是否与绝经后女性高多基因风险所带来的过度乳腺癌风险的减弱相关。方法这项前瞻性队列研究包括来自英国生物银行的绝经后妇女。使用次最大循环测力计测试估算 CRF，并使用乳腺癌多基因风险评分 (PRS) 评估遗传易感性。使用 Cox 比例风险模型以达到的年龄作为基础时间尺度来检查 CRF 和 PRS 与乳腺癌发生的关联。
- Abstract: BackgroundAlthough higher cardiorespiratory fitness (CRF) has been associated with lower breast cancer risk, whether CRF modifies the association between polygenic risk and breast cancer remains unclear. We examined the joint associations of cardiorespiratory fitness (CRF) and polygenic risk with incident breast cancer and whether higher CRF is associated with attenuation of excess breast cancer risk conferred by hi...
- Summary (fallback): 机器翻译摘要显示：背景虽然较高的心肺健康（CRF）与较低的乳腺癌风险相关，但 CRF 是否改变多基因风险与乳腺癌之间的关联仍不清楚。我们研究了心肺健康（CRF）和多基因风险与乳腺癌发生的联合关联，以及较高的 CRF 是否与绝经后女性高多基因风险所带来的过度乳腺癌风险的减弱相关。方法这项前瞻性队列研究包括来自英国生物银行的绝经后妇女。使用次最大循环测力计测试估算 CRF，并使用乳腺癌多基因风险评分 (PRS) 评估遗传易感性。使用 Cox 比例风险模型以达到的年龄作为基础时间尺度来检查 CRF 和 PRS 与乳腺癌发生的关联。
- Keywords: risk, breast, cancer, polygenic, women

### 2. [口服 Gene III(R) L-麦角硫因胶囊治疗原发性痛经的功效和安全性：随机、双盲、安慰剂对照临床试验](https://www.medrxiv.org/content/10.64898/2026.03.26.26349375v2)
- Original title: Efficacy and Safety of Oral Gene III(R) L-Ergothioneine Capsules in Primary Dysmenorrhea: A Randomized, Double-Blind, Placebo-Controlled Clinical Trial
- Authors: Guo, C., Liu, W., Ding, W., Cao, J., Tong, T. et al.
- Meta: 2026-07-18 | obstetrics and gynecology | DOI: 10.64898/2026.03.26.26349375
- 中文摘要: 目的：评估口服 L-麦角硫因 (EGT) 在缓解原发性痛经 (PD) 女性疼痛和相关症状方面的功效和安全性。方法：在这项随机、双盲、安慰剂对照试验中，40 名 PD 女性（年龄 18-30 岁）被随机（1:1）接受 EGT 胶囊（120 毫克/天）或匹配的安慰剂，连续 3 个月经周期。基线和周期后评估的结果包括峰值疼痛（视觉模拟量表，VAS）、痛经症状评分和 COX 月经症状量表（CMSS）。结果：EGT 在 3 个周期内显着改善 PD 症状。 EGT 组的峰值疼痛平均 VAS 从 4.80 {+/-} 1.12 下降至 2.32 {+/-} 1.59 (p < 0.001)，而安慰剂组则无显着下降（4.10 {+/-} 1.30 至 3.45 {+/-} 1.69）。第 3 个周期的组间差异显着 (p < 0.01)。
- Abstract: Purpose: To evaluate the efficacy and safety of oral L-ergothioneine (EGT) in alleviating pain and associated symptoms in women with primary dysmenorrhea (PD). Methods: In this randomized, double-blind, placebo-controlled trial, 40 women with PD (aged 18-30 years) were randomized (1:1) to receive EGT capsules (120 mg/day) or a matching placebo for 3 consecutive menstrual cycles. Outcomes evaluated at baseline and po...
- Summary (fallback): 机器翻译摘要显示：目的：评估口服 L-麦角硫因 (EGT) 在缓解原发性痛经 (PD) 女性疼痛和相关症状方面的功效和安全性。方法：在这项随机、双盲、安慰剂对照试验中，40 名 PD 女性（年龄 18-30 岁）被随机（1:1）接受 EGT 胶囊（120 毫克/天）或匹配的安慰剂，连续 3 个月经周期。基线和周期后评估的结果包括峰值疼痛（视觉模拟量表，VAS）、痛经症状评分和 COX 月经症状量表（CMSS）。结果：EGT 在 3 个周期内显着改善 PD 症状。 EGT 组的峰值疼痛平均 VAS 从 4.80 {+/-} 1.12 下降至 2.32 {+/-} 1.59 (p < 0.001)，而安慰剂组则无显着下降（4.10 {+/-} 1.30 至 3.45 {+/-} 1.69）。第 3 个周期的组间差异显着 (p <...
- Keywords: pain, group, oral, dysmenorrhea, randomized

### 3. [在纵向研究中量化疼痛解剖部位的个体内部差异](https://www.medrxiv.org/content/10.1101/2025.10.23.25337565v2)
- Original title: Quantifying intra-individual variations in anatomical sites of pain in longitudinal studies
- Authors: Madden, V. J., Arendse, G., Kamerman, P., Bedwell, G. J., Mqadi, L. et al.
- Meta: 2026-07-18 | pain medicine | DOI: 10.1101/2025.10.23.25337565
- 中文摘要: 背景：纵向疼痛​​研究提供了了解个体内疼痛差异的机会。然而，目前量化疼痛的解剖学程度的方法无法捕捉多个身体部位随时间的变化。我们的目标是（1）描述疼痛部位随时间变化的个体内变化模式，（2）开发一种量化疼痛部位随时间变化的个体内部变化的指标，以及（3）确定该指标是否与疼痛负担的其他指标相关。方法：我们使用了 72 名感染 HIV 病毒的参与者（51 名女性；中位 (IQR) 年龄 43 (37-51) 岁）的纵向观察队列数据，这些参与者在 49 周内每周提供疼痛严重程度、疼痛部位和痛苦的报告。结果：参与者报告显示，随着时间的推移，个体内部疼痛部位发生了显着的变化。
- Abstract: Background: Longitudinal pain studies present an opportunity to understand intra-individual variations in pain. However, current methods to quantify the anatomical extent of pain fail to capture variations across multiple body sites over time. Our aims were to (1) describe patterns of intra-individual variation in pain sites over time, (2) develop a metric that quantifies intra-individual variation in pain sites ove...
- Summary (fallback): 机器翻译摘要显示：背景：纵向疼痛​​研究提供了了解个体内疼痛差异的机会。然而，目前量化疼痛的解剖学程度的方法无法捕捉多个身体部位随时间的变化。我们的目标是（1）描述疼痛部位随时间变化的个体内变化模式，（2）开发一种量化疼痛部位随时间变化的个体内部变化的指标，以及（3）确定该指标是否与疼痛负担的其他指标相关。方法：我们使用了 72 名感染 HIV 病毒的参与者（51 名女性；中位 (IQR) 年龄 43 (37-51) 岁）的纵向观察队列数据，这些参与者在 49 周内每周提供疼痛严重程度、疼痛部位和痛苦的报告。结果：参与者报告显示，随着时间的推移，个体内部疼痛部位发生了显着的变化。
- Keywords: pain, sites, variation, intra-individual, metric

### 4. [夜间生理与痴呆症躁动发生和严重程度的关联：一项使用非接触式睡眠传感的解释性研究](https://www.medrxiv.org/content/10.64898/2026.02.27.26346707v3)
- Original title: Nocturnal Physiological Associations with Agitation Occurrence and Severity in Dementia: An Explanatory Study Using Contactless Sleep Sensing
- Authors: Liu, Z., Bono, M., Flisar, A., Decloedt, R., Van Den Bossche, M. et al.
- Meta: 2026-07-18 | geriatric medicine | DOI: 10.64898/2026.02.27.26346707
- 中文摘要: 背景：躁动是痴呆症中一种常见且繁重的神经精神症状，每天都会波动，但短期风险分层的客观工具有限。目的：我们的目的是研究来自不引人注目的床垫下传感器的夜间生理信号是否可以预测第二天的白天躁动，以及躁动发生与严重程度之间的关联是否有所不同。方法：我们从两个长期护理队列（N=55；333 晚）和一个外部家庭监测队列（N=17；801 晚）中提取心肺、运动和睡眠代理特征。使用两部分混合效应框架来模拟第二天的躁动发作。
- Abstract: Background: Agitation is a common and burdensome neuropsychiatric symptom in dementia that fluctuates from day to day, but objective tools for short-term risk stratification are limited. Objective: We aimed to investigate whether nocturnal physiological signals from unobtrusive under-mattress sensors predict next-day daytime agitation and whether associations differ for agitation occurrence versus severity. Methods:...
- Summary (fallback): 机器翻译摘要显示：背景：躁动是痴呆症中一种常见且繁重的神经精神症状，每天都会波动，但短期风险分层的客观工具有限。目的：我们的目的是研究来自不引人注目的床垫下传感器的夜间生理信号是否可以预测第二天的白天躁动，以及躁动发生与严重程度之间的关联是否有所不同。方法：我们从两个长期护理队列（N=55；333 晚）和一个外部家庭监测队列（N=17；801 晚）中提取心肺、运动和睡眠代理特征。使用两部分混合效应框架来模拟第二天的躁动发作。
- Keywords: agitation, associations, occurrence, next-day, nocturnal

### 5. [撒哈拉以南非洲地区的社区卫生工作者和青少年健康与福祉：系统评价和荟萃分析](https://www.medrxiv.org/content/10.1101/2025.09.26.25336574v2)
- Original title: Community health workers and adolescent health and well-being across sub-Saharan Africa: A systematic review and meta-analysis
- Authors: Lin, Y., Adesina, O., Asuma, B. S., Chen-Charles, J., Chalasani, S. et al.
- Meta: 2026-07-18 | public and global health | DOI: 10.1101/2025.09.26.25336574
- 中文摘要: 介绍。青春期是人生发展的关键阶段。社区卫生工作者 (CHW) 可以为解决撒哈拉以南非洲 (SSA) 的青少年健康挑战提供有价值的方法。本综述系统地综合了社区卫生工作者主导的干预措施在改善SSA青少年健康和福祉方面的有效性的证据。方法。我们检索了 14 个数据库和 17 个灰色文献来源，查找 2014 年 1 月至 2024 年 10 月期间发表的研究。该协议已在 PROSPERO 中注册（CRD42024618546）。干预措施按环境（社区或学校）和提供者（非专业人员或辅助专业人员；同伴或成人主导）进行分类。进行了计票和荟萃分析，同时使用乔安娜·布里格斯研究所的工具进行偏倚风险，并使用 GRADE 方法进行证据质量评估。结果。
- Abstract: Introduction. Adolescence represents a pivotal stage of development. Community health workers (CHWs) may offer a valuable approach to addressing adolescent health challenges in sub-Saharan Africa (SSA). This review systematically synthesised evidence on the effectiveness of CHW-led interventions to improve adolescent health and well-being in SSA. Methods. We searched 14 databases and 17 grey literature sources for s...
- Summary (fallback): 机器翻译摘要显示：介绍。青春期是人生发展的关键阶段。社区卫生工作者 (CHW) 可以为解决撒哈拉以南非洲 (SSA) 的青少年健康挑战提供有价值的方法。本综述系统地综合了社区卫生工作者主导的干预措施在改善SSA青少年健康和福祉方面的有效性的证据。方法。我们检索了 14 个数据库和 17 个灰色文献来源，查找 2014 年 1 月至 2024 年 10 月期间发表的研究。该协议已在 PROSPERO 中注册（CRD42024618546）。干预措施按环境（社区或学校）和提供者（非专业人员或辅助专业人员；同伴或成人主导）进行分类。进行了计票和荟萃分析，同时使用乔安娜·布里格斯研究所的工具进行偏倚风险，并使用 GRADE 方法进行证据质量评估。结果。
- Keywords: health, evidence, adolescent, community, across

### 6. [埃塞俄比亚精英长跑运动员的实际训练方式：人工智能辅助剖析多维训练结构。](https://www.medrxiv.org/content/10.64898/2026.05.29.26354013v2)
- Original title: How Ethiopia's elite distance runners actually train: an AI-assisted dissection of a multidimensional training structure.
- Authors: Galko, P., Yisamaw, A., Haugen, T., Seiler, S.
- Meta: 2026-07-18 | sports medicine | DOI: 10.64898/2026.05.29.26354013
- 中文摘要: 背景生成人工智能工具可以通过编写代码、起草散文、搜索分析可能性和压力测试声明来支持数据密集型研究。它们还可能产生虚假引用、统计规范之间的偏差，以及在长期调查中失去连续性。本文描述了在实证研究中使用人工智能系统的实用工作流程，同时保持发现、验证和问责制的可检查性。方法我们开发了一个三阶段人类人工智能工作流程，并将其应用于 14 名埃塞俄比亚精英长跑运动员的案例研究。该数据集包含 2025 年末连续 97 天收集的 22,605 个 GPS 片段，并辅以现场收集的场地和运动员元数据。第一阶段使用自主数据探索工具来预先过滤五个种子研究问题的假设空间。
- Abstract: BackgroundGenerative AI tools can support data-intensive research by writing code, drafting prose, searching analytical possibilities, and stress-testing claims. They can also produce false citations, drift between statistical specifications, and lose continuity across long investigations. This paper describes a practical workflow for using AI systems in empirical research while keeping discovery, verification, and...
- Summary (fallback): 机器翻译摘要显示：背景生成人工智能工具可以通过编写代码、起草散文、搜索分析可能性和压力测试声明来支持数据密集型研究。它们还可能产生虚假引用、统计规范之间的偏差，以及在长期调查中失去连续性。本文描述了在实证研究中使用人工智能系统的实用工作流程，同时保持发现、验证和问责制的可检查性。方法我们开发了一个三阶段人类人工智能工作流程，并将其应用于 14 名埃塞俄比亚精英长跑运动员的案例研究。该数据集包含 2025 年末连续 97 天收集的 22,605 个 GPS 片段，并辅以现场收集的场地和运动员元数据。第一阶段使用自主数据探索工具来预先过滤五个种子研究问题的假设空间。
- Keywords: workflow, research, claims, phase, prose

### 7. [急性头晕临床表现与脑部 CT 结果之间的相关性：三级转诊中心的回顾性横断面分析](https://www.medrxiv.org/content/10.64898/2026.06.25.26356549v2)
- Original title: Correlation Between Clinical Presentation and Brain CT Findings in Acute Dizziness: A Retrospective Cross-Sectional Analysis at a Tertiary Referral Center
- Authors: Abbasi, A., Moghbel Baerz, M., Farhadi, M., Sadegh, R., Kavari, K. et al.
- Meta: 2026-07-18 | neurology | DOI: 10.64898/2026.06.25.26356549
- 中文摘要: 背景：头晕是急诊室 (ED) 的常见主诉，需要进行广泛的诊断评估。非造影脑部计算机断层扫描 (CT) 通常用于排除严重的中枢病变，但其诊断效果存在争议，导致人们担心过度使用。本研究旨在确定与急性头晕患者异常脑部 CT 结果相关的临床预测因素，以帮助完善影像学选择标准。方法：我们对 2019 年 1 月至 2021 年期间在三级转诊中心 Namazi 医院接受非对比脑 CT 扫描的 291 名连续出现新发头晕的成年患者进行了回顾性分析。从病历中提取患者数据，包括人口统计学、合并症、临床症状和医院结果。
- Abstract: Background: Dizziness is a frequent presenting complaint in the emergency department (ED), prompting extensive diagnostic evaluation. Non-contrast brain computed tomography (CT) is often utilized to rule out serious central pathologies, but its diagnostic yield is debated, leading to concerns about overuse. This study aimed to identify clinical predictors associated with abnormal brain CT findings in patients with a...
- Summary (fallback): 机器翻译摘要显示：背景：头晕是急诊室 (ED) 的常见主诉，需要进行广泛的诊断评估。非造影脑部计算机断层扫描 (CT) 通常用于排除严重的中枢病变，但其诊断效果存在争议，导致人们担心过度使用。本研究旨在确定与急性头晕患者异常脑部 CT 结果相关的临床预测因素，以帮助完善影像学选择标准。方法：我们对 2019 年 1 月至 2021 年期间在三级转诊中心 Namazi 医院接受非对比脑 CT 扫描的 291 名连续出现新发头晕的成年患者进行了回顾性分析。从病历中提取患者数据，包括人口统计学、合并症、临床症状和医院结果。
- Keywords: clinical, brain, findings, dizziness, acute

### 8. [Gene III(R) L-麦角硫因胶囊对产后疲劳、睡眠质量和生活质量的功效：一项随机、双盲、安慰剂对照试验](https://www.medrxiv.org/content/10.64898/2026.06.08.26355132v2)
- Original title: Efficacy of Gene III(R) L-Ergothioneine Capsules on Postpartum Fatigue, Sleep Quality, and Quality of Life: A Randomized, Double-Blind, Placebo-Controlled Trial
- Authors: Liu, W., Guo, C., Ding, W., Cao, J., Tong, T. et al.
- Meta: 2026-07-18 | obstetrics and gynecology | DOI: 10.64898/2026.06.08.26355132
- 中文摘要: 背景：产后乏力以严重疲劳、睡眠障碍和生理应激为特征，缺乏有效的针对性干预措施。麦角硫因 (EGT) 是一种独特的天然抗氧化剂，可在线粒体中积极积累，为全身恢复提供令人信服的治疗原理。本研究旨在评估EGT在加速产后功能恢复和缓解疲劳方面的功效。方法：这项单中心、随机、双盲、安慰剂对照试验纳入了 40 名已停止母乳喂养的产后妇女（SF-36 总分 [≤] 70）。参与者被随机 (1:1) 接受 120 毫克/天的 EGT 或匹配的安慰剂，为期 30 天。使用 SF-36、匹兹堡睡眠质量指数 (PSQI)、疲劳量表-14 (FS-14) 和中医 (TCM) 虚弱量表评估疗效。
- Abstract: Background: Postpartum asthenia, characterized by severe fatigue, sleep disturbances, and physiological stress, lacks effective targeted interventions. Ergothioneine (EGT) is a unique, naturally occurring antioxidant that actively accumulates in mitochondria, offering a compelling therapeutic rationale for systemic recovery. This study aimed to evaluate the efficacy of EGT in accelerating postpartum functional resto...
- Summary (fallback): 机器翻译摘要显示：背景：产后乏力以严重疲劳、睡眠障碍和生理应激为特征，缺乏有效的针对性干预措施。麦角硫因 (EGT) 是一种独特的天然抗氧化剂，可在线粒体中积极积累，为全身恢复提供令人信服的治疗原理。本研究旨在评估EGT在加速产后功能恢复和缓解疲劳方面的功效。方法：这项单中心、随机、双盲、安慰剂对照试验纳入了 40 名已停止母乳喂养的产后妇女（SF-36 总分 [≤] 70）。参与者被随机 (1:1) 接受 120 毫克/天的 EGT 或匹配的安慰剂，为期 30 天。使用 SF-36、匹兹堡睡眠质量指数 (PSQI)、疲劳量表-14 (FS-14) 和中医 (TCM) 虚弱量表评估疗效。
- Keywords: fatigue, postpartum, sleep, quality, trial

### 9. [从初潮到更年期：激素对功能性神经疾病的影响](https://www.medrxiv.org/content/10.64898/2026.07.16.26358260v1)
- Original title: From Menarche to Menopause: Hormonal Influences on Functional Neurological Disorder
- Authors: Palmer, D. D. G., Warren, N., Morton, A., Lehn, A.
- Meta: 2026-07-18 | neurology | DOI: 10.64898/2026.07.16.26358260
- 中文摘要: 背景 功能性神经系统疾病 (FND) 是最常见的神经系统疾病之一，影响女性的频率几乎是男性的两倍。其原因尚不清楚，并且对女性健康的生理和病理特征如何与 FND 症状相互作用的研究也很少。方法 我们进行了一项在线调查，评估 FND 症状严重程度对女性健康多个方面的影响。结果 484 人完成了调查。在 223 名月经周期规律或相当规律的人中，不同月经周期的症状存在显着差异，卵泡期症状最佳，黄体期恶化，经前期和月经期症状最严重。这种效应并没有被经前焦虑症（PMDD）的替代指标所调节。
- Abstract: Background Functional neurological disorder (FND), one of the most common neurological conditions, affects women almost twice as frequently as men. The reasons for this are unknown, and there has been minimal research into how physiological and pathological features of women's health interact with symptoms of FND. Methods We conducted an online survey assessing the effect of several aspects of women's health with th...
- Summary (fallback): 机器翻译摘要显示：背景 功能性神经系统疾病 (FND) 是最常见的神经系统疾病之一，影响女性的频率几乎是男性的两倍。其原因尚不清楚，并且对女性健康的生理和病理特征如何与 FND 症状相互作用的研究也很少。方法 我们进行了一项在线调查，评估 FND 症状严重程度对女性健康多个方面的影响。结果 484 人完成了调查。在 223 名月经周期规律或相当规律的人中，不同月经周期的症状存在显着差异，卵泡期症状最佳，黄体期恶化，经前期和月经期症状最严重。这种效应并没有被经前焦虑症（PMDD）的替代指标所调节。
- Keywords: symptoms, women, worsening, menopause, neurological

### 10. [24S-羟基胆固醇：亨廷顿病的潜在脑源生物标志物](https://www.medrxiv.org/content/10.1101/2025.10.08.25337337v2)
- Original title: 24S-Hydroxycholesterol: A potential brain-derived biomarker of Huntington's Disease
- Authors: Ali Asgari, M., Langbehn, D. R., Skibinski, D. O. F., Lee, R., Griffiths, W. J. et al.
- Meta: 2026-07-18 | neurology | DOI: 10.1101/2025.10.08.25337337
- 中文摘要: 亨廷顿氏舞蹈病 (HD) 是由亨廷顿基因外显子 1 中扩展的多聚谷氨酰胺编码三核苷酸重复引起的。尽管进行了大量研究，但成功的疾病修饰疗法尚未得到证实。大脑中的胆固醇稳态被认为是 HD 中受到干扰的生物过程之一。在当前的研究中，我们使用基于多级裂解的液相色谱-质谱分析法显示，非酯化24S-羟基胆固醇（24S-HC）是一种可以穿过血脑屏障的立体特异性脑源性胆固醇代谢物，在患有明显HD的人群中，血浆中的浓度低于患有前期HD的人群或健康对照者。
- Abstract: Huntington's disease (HD) arises from of an expanded polyglutamine-coding trinucleotide repeat in exon 1 of the huntingtin gene. Despite considerable research, a successful disease modifying therapy has yet to be confirmed. Cholesterol homeostasis in brain is considered one of the biological processes to be disturbed in HD. In the current study we have shown, using liquid chromatography - mass spectrometry with mult...
- Summary (fallback): 机器翻译摘要显示：亨廷顿氏舞蹈病 (HD) 是由亨廷顿基因外显子 1 中扩展的多聚谷氨酰胺编码三核苷酸重复引起的。尽管进行了大量研究，但成功的疾病修饰疗法尚未得到证实。大脑中的胆固醇稳态被认为是 HD 中受到干扰的生物过程之一。在当前的研究中，我们使用基于多级裂解的液相色谱-质谱分析法显示，非酯化24S-羟基胆固醇（24S-HC）是一种可以穿过血脑屏障的立体特异性脑源性胆固醇代谢物，在患有明显HD的人群中，血浆中的浓度低于患有前期HD的人群或健康对照者。
- Keywords: disease, cholesterol, people, s-hc, manifest

### 11. [比较剖腹产后测量的失血量和计算的失血量](https://www.medrxiv.org/content/10.64898/2026.07.16.26358295v1)
- Original title: Comparing measured and calculated blood loss after a caesarean birth
- Authors: Mansukhani, R., Arribas, M., Bello, N., Chaudhri, R., Geer, A. et al.
- Meta: 2026-07-18 | obstetrics and gynecology | DOI: 10.64898/2026.07.16.26358295
- 中文摘要: 简介 准确测量剖腹产后失血量对于早期识别产后出血非常重要。常用的目视估计低估了失血量。我们比较了两种客观评估失血量的方法。方法通过称重拭子和垫以及抽吸和手术巾中的血液来获得测量的失血量。计算的失血量是根据母亲体重和围产期血红蛋白变化得出的。数据来自 I'M WOMAN 试验，该试验调查氨甲环酸预防产后出血的作用。这是对前瞻性收集的试验数据的二次分析。我们报告了中位失血量 (IQR)，使用 Bland-Altman 分析评估了一致性，并比较了超过 500 毫升、1000 毫升和 1500 毫升的女性百分比。我们按测得的失血量类别绘制了血红蛋白下降比例图，并按贫血状况分层...
...
- Summary (fallback): 机器翻译摘要显示：简介 准确测量剖腹产后失血量对于早期识别产后出血非常重要。常用的目视估计低估了失血量。我们比较了两种客观评估失血量的方法。方法通过称重拭子和垫以及抽吸和手术巾中的血液来获得测量的失血量。计算的失血量是根据母亲体重和围产期血红蛋白变化得出的。数据来自 I'M WOMAN 试验，该试验调查氨甲环酸预防产后出血的作用。这是对前瞻性收集的试验数据的二次分析。我们报告了中位失血量 (IQR)，使用 Bland-Altman 分析评估了一致性，并比较了超过 500 毫升、1000 毫升和 1500 毫升的女性百分比。我们按测得的失血量类别绘制了血红蛋白下降比例图，并按贫血状况分层...
- Keywords: blood, loss, measured, calculated, women

### 12. [结直肠癌筛查的不平等：将 MAIHDA 与双重差分法结合起来评估计划对不同人群亚组的影响](https://www.medrxiv.org/content/10.64898/2026.07.16.26358242v1)
- Original title: Inequalities in Colorectal Cancer Screening: Combining MAIHDA with Difference-in-Differences to Assess Programme Effects Across Population Subgroups
- Authors: Jolidon, V., Delaruelle, K., Kawachi, I., Cullati, S., Bell, A. et al.
- Meta: 2026-07-18 | health policy | DOI: 10.64898/2026.07.16.26358242
- 中文摘要: 背景：研究一致表明结直肠癌 (CRC) 筛查的采用具有社会模式；然而，社会人口决定因素通常是单独分析的，忽视了多种社会条件如何共同塑造不平等。这也适用于政策研究，其中筛选计划效果的异质性仍未得到充分探索。方法：利用欧洲健康访谈调查（2014 年和 2019 年；n=201,214；24 个国家）的数据，我们应用个体异质性和歧视准确性的多层次分析 (MAIHDA) 来分析按性别、教育、生活安排和就业定义的 72 个亚组的 CRC 筛查情况。为了评估筛查计划效果的异质性，我们将 MAIHDA 与双重差分 (MAIHDA-DiD) 结合起来。
- Abstract: Background: Research consistently shows that colorectal cancer (CRC) screening uptake is socially patterned; however, sociodemographic determinants are usually analysed separately, overlooking how multiple social conditions jointly shape inequalities. This also applies to policy research, where heterogeneity in screening programme effects remains underexplored. Methods: Using data from the European Health Interview...
- Summary (fallback): 机器翻译摘要显示：背景：研究一致表明结直肠癌 (CRC) 筛查的采用具有社会模式；然而，社会人口决定因素通常是单独分析的，忽视了多种社会条件如何共同塑造不平等。这也适用于政策研究，其中筛选计划效果的异质性仍未得到充分探索。方法：利用欧洲健康访谈调查（2014 年和 2019 年；n=201,214；24 个国家）的数据，我们应用个体异质性和歧视准确性的多层次分析 (MAIHDA) 来分析按性别、教育、生活安排和就业定义的 72 个亚组的 CRC 筛查情况。为了评估筛查计划效果的异质性，我们将 MAIHDA 与双重差分 (MAIHDA-DiD) 结合起来。
- Keywords: uptake, screening, living, inequalities, maihda

### 13. [乌干达东部地区转诊医院五岁以下疟疾儿童延迟获得护理的相关因素及其结果](https://www.medrxiv.org/content/10.64898/2026.07.16.26358296v1)
- Original title: Factors associated with delayed access of care among children under five with malaria and their outcomes at a regional referral hospital in Eastern Uganda
- Authors: Yung, K. M. M., Ssenyonga, L. V., Oboth, P., Lyagoba, I., Olowo, S. et al.
- Meta: 2026-07-18 | health systems and quality improvement | DOI: 10.64898/2026.07.16.26358296
- 中文摘要: 简介：乌干达是东非和南部非洲疟疾病例最多的国家，占 2020 年死亡人数的 3%。这需要预防、早期诊断和治疗疟疾，特别是对于那些病情可能在 24 小时内发展为严重疟疾的儿童。尽管已经采取了许多干预措施来预防疟疾传播，但患病时延误诊断和治疗疟疾可能会导致进一步的死亡。因此，需要探讨与五岁以下疟疾儿童延迟获得护理相关的因素及其结果。方法：进行横断面研究。目标人群是姆巴莱地区转诊医院五岁以下患有疟疾的儿童的父母/看护者。对目标人群使用了连续抽样技术。
- Abstract: Introduction: Uganda has the highest number of Malaria cases in East and Southern Africa and accounted for 3% of deaths in 2020. This calls for prevention, early diagnosis and treatment of Malaria most especially among children whose condition can progress to severe Malaria within 24 hours. While numerous interventions have been put into place to prevent malaria transmission, delays in diagnosis and treatment of Mal...
- Summary (fallback): 机器翻译摘要显示：简介：乌干达是东非和南部非洲疟疾病例最多的国家，占 2020 年死亡人数的 3%。这需要预防、早期诊断和治疗疟疾，特别是对于那些病情可能在 24 小时内发展为严重疟疾的儿童。尽管已经采取了许多干预措施来预防疟疾传播，但患病时延误诊断和治疗疟疾可能会导致进一步的死亡。因此，需要探讨与五岁以下疟疾儿童延迟获得护理相关的因素及其结果。方法：进行横断面研究。目标人群是姆巴莱地区转诊医院五岁以下患有疟疾的儿童的父母/看护者。对目标人群使用了连续抽样技术。
- Keywords: malaria, care, children, under, five

### 14. [CAUSAL-RSV：使用真实世界数据对婴儿 RSV 疫苗效果进行因果分析](https://www.medrxiv.org/content/10.64898/2026.07.16.26356876v1)
- Original title: CAUSAL-RSV: Causal Analysis of RSV Vaccine Effects in Infants Using Real-World Data
- Authors: Regan, A. K., Coates, M. M., Sullivan, S. G., Munoz, F. M., Rowe, S. L. et al.
- Meta: 2026-07-18 | infectious diseases | DOI: 10.64898/2026.07.16.26356876
- 中文摘要: 呼吸道合胞病毒 (RSV) 每年都会导致幼儿大量发病和死亡。 2023年，两种新的预防产品在美国获得许可和推荐，包括在怀孕期间注射的预融合F蛋白亚单位疫苗（RSVpreF）和在婴儿中注射的长效单克隆抗体（mAb）。尽管获得许可后的真实世界研究支持 RSVpreF 疫苗在怀孕期间的有效性，但现有研究是在仅提供 RSVpreF 疫苗的环境中进行的。在同时提供 RSVpreF 疫苗和 mAb 的环境中，RSVpreF 疫苗的实际有效性尚不清楚。本研究的目的是通过应用因果中介分析（以单克隆抗体作为中介变量）来评估 RSVpreF 疫苗针对严重婴儿 RSV 的实际有效性。
- Abstract: Respiratory syncytial virus (RSV) contributes to substantial morbidity and mortality in young children each year. In 2023, two new prevention products were licensed and recommended in the United States (US), including a prefusion F protein subunit vaccine (RSVpreF) administered during pregnancy and a long-acting monoclonal antibody (mAb) administered in infants. Although post-licensure real-world studies support the...
- Summary (fallback): 机器翻译摘要显示：呼吸道合胞病毒 (RSV) 每年都会导致幼儿大量发病和死亡。 2023年，两种新的预防产品在美国获得许可和推荐，包括在怀孕期间注射的预融合F蛋白亚单位疫苗（RSVpreF）和在婴儿中注射的长效单克隆抗体（mAb）。尽管获得许可后的真实世界研究支持 RSVpreF 疫苗在怀孕期间的有效性，但现有研究是在仅提供 RSVpreF 疫苗的环境中进行的。在同时提供 RSVpreF 疫苗和 mAb 的环境中，RSVpreF 疫苗的实际有效性尚不清楚。本研究的目的是通过应用因果中介分析（以单克隆抗体作为中介变量）来评估 RSVpreF 疫苗针对严重婴儿 RSV 的实际有效性。
- Keywords: vaccine, rsvpref, real-world, effectiveness, causal
